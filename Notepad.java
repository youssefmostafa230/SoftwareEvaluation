...
if (retrieval == JFileChooser.APPROVE_OPTION)
{
	...
	if (extension.equals("Java Source Files(*.java)")) 
	{
	    ext = ".java";
	}
	else if (extension.equals("Text Files(*.txt)")) 
	{
	    ext = ".txt";
	}
}*/
do
{
int retrieval = chooser.showSaveDialog(this.npd.f);
if(retrieval!=JFileChooser.APPROVE_OPTION)
	return false;
...
//File temp1 = chooser.getSelectedFile();
//chooser.setAcceptAllFileFilterUsed(true);
System.out.println("file ext :"+temp+ ext); 
...
System.out.println("file: "+fileRef);
...
JMenuItem cutItem, copyItem, deleteItem, undoItem, findItem, findNextItem, replaceItem, gotoItem, selectAllItem;
/****************************/
Notepad()
{
...
else if(cmdText.equals(editUndo))
{
	...
	//undoItem.addActionListener((ActionListener) this);
